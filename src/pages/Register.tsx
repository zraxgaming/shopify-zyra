...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send welcome email via Resend API with branding
      try {
        ...
        await fetch('/api/send-email-generic', {
          ...
          body: JSON.stringify({
            ...
            html: zyraEmailTemplate({
              ...
              body: `<p style="font-size:1.1rem;color:#6b21a8;">Hello <b>${formData.firstName || formData.email}</b>,</p><p style="color:#4b006e;">Thank you for signing up at Zyra. We're excited to have you join our community!</p>`,
              ctaText: 'Visit Zyra',
