              ...
              <div style="background: linear-gradient(135deg, #a18cd1 0%, #fbc2eb 100%); padding: 32px 0; min-height: 100vh; font-family: 'Segoe UI', Arial, sans-serif;">
                <div style="max-width: 480px; margin: 0 auto; background: #fff; border-radius: 16px; box-shadow: 0 4px 24px rgba(80,0,120,0.08); overflow: hidden;">
                  <div style="background: #7c3aed; padding: 24px 0; text-align: center;">
                    ...
                    <h1 style="color: #fff; font-size: 2rem; margin: 16px 0 0 0; letter-spacing: 1px;">Welcome to Zyra!</h1>
                  </div>
                  <div style="padding: 32px 24px 24px 24px; text-align: center;">
                    <p style="font-size: 1.1rem; color: #6b21a8; margin-bottom: 16px;">Hello <b>${formData.firstName || formData.email}</b>,</p>
                    <p style="color: #4b006e; margin-bottom: 16px;">Thank you for signing up at Zyra. We're excited to have you join our community!</p>
                    <a href="https://www.shopzyra.site/" style="display:inline-block;margin:24px 0 0 0;padding:12px 32px;background:#a18cd1;color:#fff;border-radius:8px;text-decoration:none;font-weight:600;box-shadow:0 2px 8px #a18cd1;">Visit Zyra</a>
                  </div>
